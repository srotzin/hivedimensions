...
const DID='did:hive:hivedimensions';const ID={name:'HiveDimensions',purpose:'Multi-axis coordination — parallel, pipeline, convergence',capabilities:['parallel_execution','pipeline_orchestration','convergence','dimensional_routing'],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hivedimensions',purpose:ID.purpose})}
